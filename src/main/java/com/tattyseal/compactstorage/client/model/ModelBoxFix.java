...
public class ModelBoxFix extends ModelBox
{
    ...
    public ModelBoxFix(ModelRenderer renderer, int texU, int texV, float x, float y, float z, float sx, float sy, float sz, float delta, boolean mirror)
    {
        super(renderer, texU, texV, x, y, z, (int) sx, (int) sy, (int) sz, delta, mirror);
